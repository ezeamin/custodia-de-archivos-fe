          ...
          >
            ...
            {isOptionSelected ? (
              <Button
                ...
                className="absolute inset-y-[1px] right-[1px] flex h-auto items-center bg-gray-100 px-3 hover:bg-gray-200 disabled:bg-transparent dark:bg-slate-700 hover:dark:bg-slate-800 dark:disabled:bg-transparent"
                disabled={disabled}
                type="button"
